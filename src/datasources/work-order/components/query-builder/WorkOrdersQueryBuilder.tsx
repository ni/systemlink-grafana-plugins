...
import { QBField } from "datasources/work-order/types";
...
import { WorkOrderQueryBuilderFields, WorkOrderQueryBuilderStaticFields } from "datasources/work-order/constants/WorkOrderQueryBuilder.constants";
...
export const WorkOrdersQueryBuilder: React.FC<WorkOrdersQueryBuilderProps> = ({
  ...
  const workspaceField = useMemo(() => {
    const workspaceField = WorkOrderQueryBuilderFields.WORKSPACE;
  ...
  const updatedAtField = useMemo(() => {
    const updatedField = WorkOrderQueryBuilderFields.UPDATEDAT;
    return {
      ...updatedField,
      lookup: {
        ...updatedField.lookup,
  ...
  const partNumberField = useMemo(() => {
    const partNumberField = WorkOrderQueryBuilderFields.ID;
  ...
  useEffect(() => {
    const updatedFields = [partNumberField, ...WorkOrderQueryBuilderStaticFields!, updatedAtField, workspaceField]
      .map((field) => {
