...
const calibrationForecastResponseMock: CalibrationForecastResponse = {
  calibrationForecast: {
    columns: [
      {
        name: 'Time',
        values: ['2024-07-24T00:00:00Z', '2024-08-24T00:00:00Z', '2024-09-24T00:00:00Z', '2024-10-24T00:00:00Z', '2024-11-24T00:00:00Z', '2024-12-24T00:00:00Z']
      },
...
describe('queries', () => {
  ...
  describe('format dates', () => {
    test('format day', () => {
      const field = ds.formatField({
        name: "Time",
        values: ['2024-07-24T00:00:00Z']
      }, { groupBy: [AssetCalibrationForecastGroupByType.Day], queryKind: null!, refId: null! })
    ...
    test('format week', () => {
      const field = ds.formatField({
        name: "Time",
        values: ['2024-07-24T00:00:00Z']
      }, { groupBy: [AssetCalibrationForecastGroupByType.Week], queryKind: null!, refId: null! })
    ...
    test('format month', () => {
      const field = ds.formatField({
        name: "Time",
        values: ['2024-07-24T00:00:00Z']
      }, { groupBy: [AssetCalibrationForecastGroupByType.Month], queryKind: null!, refId: null! })
