...
> **Note:** The _SystemLink Test Plans_ data source is deprecated and will soon be removed. Please use the _SystemLink Work Items_ data source instead. It supports test plans along with all other work item types.
