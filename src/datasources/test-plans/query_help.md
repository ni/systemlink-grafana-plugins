...
> **Note:** The _SystemLink Test Plans_ data source is deprecated and will soon stop receiving support and new features. Please use the _SystemLink Work Items_ data source instead. It supports test plans along with all other work item types. For more information, refer to <a href="https://www.ni.com/docs/en-US/bundle/systemlink-enterprise/page/creating-a-test-plan.html" target="_blank" rel="noopener noreferrer">Creating a Work Item</a>.
