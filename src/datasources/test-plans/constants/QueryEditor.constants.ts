...
export const deprecationMessage = {
    ...
    message:
        'The SystemLink Test Plans data source is deprecated and will soon stop receiving support and new features. Please use the SystemLink Work Items data source instead. It supports test plans along with all other work item types. For more information, refer to ',
