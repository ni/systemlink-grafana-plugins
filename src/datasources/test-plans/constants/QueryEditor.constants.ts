...
export const deprecationMessage = {
    ...
    message:
        'The SystemLink Test Plans data source is deprecated and will soon be removed. Please use the SystemLink Work Items data source instead. It supports test plans along with all other work item types. For more information, refer to ',
