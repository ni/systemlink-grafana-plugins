...
import { QBField } from "datasources/test-plan/types";
...
import { TestPlanQueryBuilderFields, TestPlanQueryBuilderStaticFields } from "datasources/test-plan/constants/TestPlanQueryBuilder.constants";
...
export const TestPlansQueryBuilder: React.FC<TestPlansQueryBuilderProps> = ({
  ...
  const workspaceField = useMemo(() => {
    const workspaceField = TestPlanQueryBuilderFields.WORKSPACE;
  ...
  const updatedAtField = useMemo(() => {
    const updatedField = TestPlanQueryBuilderFields.UPDATEDAT;
    return {
      ...updatedField,
      lookup: {
        ...updatedField.lookup,
  ...
  const partNumberField = useMemo(() => {
    const partNumberField = TestPlanQueryBuilderFields.ID;
  ...
  useEffect(() => {
    const updatedFields = [partNumberField, ...TestPlanQueryBuilderStaticFields!, updatedAtField, workspaceField]
      .map((field) => {
