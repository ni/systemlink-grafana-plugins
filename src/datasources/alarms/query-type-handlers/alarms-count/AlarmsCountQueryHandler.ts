...
import { defaultAlarmsCountQuery } from 'datasources/alarms/constants/DefaultQueries.contants';
...
export class AlarmsCountQueryHandler extends AlarmsQueryHandlersCore {
