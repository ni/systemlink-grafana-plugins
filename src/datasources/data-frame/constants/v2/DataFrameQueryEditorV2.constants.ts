...
export const labels = {
    ...
    queryByResultProperties: 'Query by results properties',
    columns: 'Columns',
...
export const tooltips = {
    ...
    queryByResultProperties: 'This optional field applies a results filter to a query while searching the data tables.',
