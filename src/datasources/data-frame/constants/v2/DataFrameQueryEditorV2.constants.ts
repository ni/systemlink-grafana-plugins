...
export const labels = {
    ...
    appendColumnUnitInFieldName: 'Append column unit in field name',
...
export const tooltips = {
    ...
    appendColumnUnitInFieldName: 'Specifies whether to append the column unit in the response data.',
