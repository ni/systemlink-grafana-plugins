...
export const tooltips = {
    ...
    undecimatedRecordCount: `This field sets the maximum number of rows to return per data table. If the total number of data points exceeds the allowed limit of ${MAXIMUM_DATA_POINTS}, the take value will be dynamically reduced to keep the total data points under the limit.`,
