...
When using the **Filter by x-axis range on zoom or pan** feature on data tables with numeric columns, excessive use of zoom and pan operations can cause a URI Length error.
