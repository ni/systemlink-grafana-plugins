...
| **Data Table Custom Properties** | 10,000 | If the matching data tables contain more than 10,000 unique custom property keys, the data source only returns the first 10,000 as fields. |
