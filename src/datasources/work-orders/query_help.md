...
> **Note:** The _SystemLink Work Orders_ data source is deprecated and will soon be removed. Please use the _SystemLink Work Items_ data source instead. It supports work orders along with all other work item types.
