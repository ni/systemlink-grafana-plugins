...
describe('WorkOrdersVariableQueryEditor', () => {
  ...
  it('should render the deprecation notice', async () => {
    ...
    // TODO [Task 4073979]: Uncomment once the documentation link is added back to the notice.
  ...
  describe('onChange', () => {
    ...
    it('should show error message when when user changes take to number less than min take', async () => {
      ...
      await waitFor(() => {
        ...
        expect(mockOnChange).toHaveBeenCalledWith(expect.objectContaining({ take: NaN }));
      });
    });
