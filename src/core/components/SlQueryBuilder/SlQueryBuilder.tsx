...
export const SlQueryBuilder: React.FC<SlQueryBuilderProps> = ({
  ...
  // Function to get the QueryBuilder instance without using direct ref
  const getQueryBuilderInstance = React.useCallback(() => {
    ...
    // Access the QueryBuilder instance through the DOM
  ...
  return (
    <div ref={wrapperRef}>
      <QueryBuilder
        ...
        fields={sortedFields}
        messages={messages}
        // Prevents navigation to javascript:void(0), dropdowns have ul>li>a[href="javascript:void(0)"] structure
